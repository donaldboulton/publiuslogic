...
meta_title: 'How I added Disqus Comments to Gatsby v2 Starter Business'
meta_description: >-
  If you're running a Gatsby blog (or any React-powered blog for that matter) and you'd like to add comment functionality, rest assured, it's very easy.
tags:
  - WebDev
  - Tutorial
---
...
4. Go to your template file for blog post (in my case `src/components/ArticleTemplate`) and import the `DiscussionEmbed` React component.
