...
import {Link} from 'styled-icons/fa-solid/ExternalLinkAlt'
        ...
        <div className='card'>
          ...
          <div className='card-content'>
            ...
            <div className='content'>
              ...
              <br />
              <div><a href='https://github.com/donaldboulton/' rel='me'><span className='icon is-small has-text-light'><GithubAlt /></span>&nbsp;My GitHub Repos</a></div>
              ...
              <br />
              <span>
                <a href='https://donboulton.com'><span className='icon is-small has-text-light'><Link /></span>&nbsp;Designer donboulton.com</a>
              </span>
            </div>
          </div>
        </div>
        ...
        <div className='card'>
          ...
          <div className='card-content'>
            ...
            <div className='content'>
              ...
              <br />
              <div><a href='https://www.gatsbyjs.org/'><span className='icon is-small has-text-light'><Link /></span>&nbsp;Framework Gatsby -v2.1</a></div>
              <div><a href='https://bulma.io/'><span className='icon is-small has-text-light'><Link /></span>&nbsp;CSS from @bulma.io</a></div>
              <div><a href='https://www.gatsbyjs.org/packages/gatsby-plugin-styled-components/'><span className='icon is-small has-text-light'><Link /></span>&nbsp;Styled Components Icons</a></div>
              <br />
        ...
        <div className='card'>
          ...
          <div className='card-content'>
            ...
            <div className='content'>
              ...
              <br />
              <div><a title='Netlify' href='https://netlify.com' target='_blank' rel='noopener noreferrer'><span className='icon is-small has-text-light'><Link /></span>&nbsp;Netlify Home Page</a></div>
              <div><a href='https://www.netlify.com/features/'><span className='icon is-small has-text-light'><Link /></span>&nbsp;SLL Security</a></div>
              <div><a href='https://app.netlify.com/signup?_ga=2.257002891.1243890719.1552279568-538917114.1550763563'><span className='icon is-small has-text-light'><Link /></span>&nbsp;Netlify Free Tier</a></div>
              <br />
